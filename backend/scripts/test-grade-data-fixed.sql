...
INSERT INTO exam_sessions (user_id, session_code, status, expires_at, duration, started_at, completed_at, created_at, updated_at) VALUES
('coba1', 'EXAM_coba1_1769659900', 'COMPLETED', NOW() + INTERVAL '2 hours', 130, NOW() - INTERVAL '1 hour', NOW(), NOW(), NOW()),
('coba2', 'EXAM_coba2_1769659900', 'COMPLETED', NOW() + INTERVAL '2 hours', 130, NOW() - INTERVAL '1 hour', NOW(), NOW(), NOW()),
('coba3', 'EXAM_coba3_1769659900', 'COMPLETED', NOW() + INTERVAL '2 hours', 130, NOW() - INTERVAL '1 hour', NOW(), NOW(), NOW());

-- Insert exam summaries for COBA1 (Grade A - 100% = 690 points)
INSERT INTO exam_summaries (exam_session_id, user_id, total_questions, total_answered, total_score, max_score, overall_percentage, overall_grade, is_passed, completed_at, created_at, updated_at)
...
INSERT INTO exam_results (exam_session_id, category, total_questions, total_answered, total_score, max_score, percentage, grade, is_passed, created_at, updated_at)
...
-- Insert exam summaries for COBA2 (Grade B - 90% = 621 points)
INSERT INTO exam_summaries (exam_session_id, user_id, total_questions, total_answered, total_score, max_score, overall_percentage, overall_grade, is_passed, completed_at, created_at, updated_at)
...
-- Insert exam summaries for COBA3 (Grade C - 80% = 552 points)
INSERT INTO exam_summaries (exam_session_id, user_id, total_questions, total_answered, total_score, max_score, overall_percentage, overall_grade, is_passed, completed_at, created_at, updated_at)
...
SELECT user_id, total_score, max_score, overall_percentage, overall_grade, is_passed FROM exam_summaries WHERE user_id = 'coba1';

SELECT 'COBA2 Results' as test_user;  
SELECT user_id, total_score, max_score, overall_percentage, overall_grade, is_passed FROM exam_summaries WHERE user_id = 'coba2';

SELECT 'COBA3 Results' as test_user;
SELECT user_id, total_score, max_score, overall_percentage, overall_grade, is_passed FROM exam_summaries WHERE user_id = 'coba3';